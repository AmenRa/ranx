...
from ranx.normalization import max_norm_parallel, min_max_norm_parallel
...
def test_max_norm(run):
    norm_run = max_norm_parallel(run.run.copy())
...
def test_min_max_norm(run):
    norm_run = min_max_norm_parallel(run.run.copy())
